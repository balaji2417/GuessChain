                ...
                if error == nil {
                    ...
                    if let error = error {
                        ...
                        if let authError = AuthErrorCode(rawValue: nsError.code) {
                            ...
                            print("NS Error :\(authError)")
                            switch authError {
                                
                            case .emailAlreadyInUse:
                                print("Im here")
                                
                                self.showAlert(message: "This email address is already in use by another account.")
                                
                            case .weakPassword:
                                
                                self.showAlert(message: "The password is too weak. It must be at least 6 characters.")
